...
// End Cross Module References
	...
	UMoneySave::UMoneySave(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UMoneySave);
	UMoneySave::~UMoneySave() {}
	struct Z_CompiledInDeferFile_FID_projProblox_Source_projProblox_SaveFiles_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_projProblox_Source_projProblox_SaveFiles_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_projProblox_Source_projProblox_SaveFiles_h_1413595319(TEXT("/Script/projProblox"),
		Z_CompiledInDeferFile_FID_projProblox_Source_projProblox_SaveFiles_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_projProblox_Source_projProblox_SaveFiles_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
