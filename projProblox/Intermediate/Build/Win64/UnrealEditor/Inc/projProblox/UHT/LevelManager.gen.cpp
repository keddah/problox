...
// End Cross Module References
	...
	DEFINE_FUNCTION(ALevelManager::execOnAllLevelsUnloaded)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->OnAllLevelsUnloaded();
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(ALevelManager::execLoadLevel)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->LoadLevel(Z_Param_lvlIndex);
		P_NATIVE_END;
	}
	void ALevelManager::StaticRegisterNativesALevelManager()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "OnAllLevelsUnloaded", &ALevelManager::execOnAllLevelsUnloaded },
	...
	struct Z_Construct_UFunction_ALevelManager_OnAllLevelsUnloaded_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ALevelManager_OnAllLevelsUnloaded_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "LevelManager.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ALevelManager_OnAllLevelsUnloaded_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ALevelManager, nullptr, "OnAllLevelsUnloaded", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ALevelManager_OnAllLevelsUnloaded_Statics::Function_MetaDataParams), Z_Construct_UFunction_ALevelManager_OnAllLevelsUnloaded_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_ALevelManager_OnAllLevelsUnloaded()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ALevelManager_OnAllLevelsUnloaded_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ALevelManager_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ALevelManager_LoadLevel, "LoadLevel" }, // 258679821
		{ &Z_Construct_UFunction_ALevelManager_OnAllLevelsUnloaded, "OnAllLevelsUnloaded" }, // 3838218159
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Deany_Documents_GitHub_problox_projProblox_Source_projProblox_LevelManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ALevelManager, ALevelManager::StaticClass, TEXT("ALevelManager"), &Z_Registration_Info_UClass_ALevelManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALevelManager), 2860647992U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Deany_Documents_GitHub_problox_projProblox_Source_projProblox_LevelManager_h_4271100159(TEXT("/Script/projProblox"),
