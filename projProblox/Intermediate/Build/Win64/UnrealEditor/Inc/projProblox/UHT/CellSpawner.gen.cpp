...
void FOnSpawnTriggered_DelegateWrapper(const FMulticastScriptDelegate& OnSpawnTriggered, ACellSpawner* triggeredSpawner)
{
	...
	DEFINE_FUNCTION(ACellSpawner::execOverlap)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->Overlap(Z_Param_otherActor);
		P_NATIVE_END;
	}
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Uni_problox_projProblox_Source_projProblox_Cells_CellSpawner_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACellSpawner, ACellSpawner::StaticClass, TEXT("ACellSpawner"), &Z_Registration_Info_UClass_ACellSpawner, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACellSpawner), 3632819786U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Uni_problox_projProblox_Source_projProblox_Cells_CellSpawner_h_1383813595(TEXT("/Script/projProblox"),
