...
template<> PROJPROBLOX_API UScriptStruct* StaticStruct<FTask>()
{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FTask_Statics::NewProp_obj_MetaData[] = {
		{ "Category", "Task" },
		{ "ModuleRelativePath", "UndoRedo/ActionHistory.h" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FTask_Statics::NewProp_obj = { "obj", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTask, obj), Z_Construct_UClass_APickupableMaster_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTask_Statics::NewProp_obj_MetaData), Z_Construct_UScriptStruct_FTask_Statics::NewProp_obj_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FTask_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FTask_Statics::NewProp_obj,
	...
	struct Z_CompiledInDeferFile_FID_projProblox_Source_projProblox_UndoRedo_ActionHistory_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_projProblox_Source_projProblox_UndoRedo_ActionHistory_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_projProblox_Source_projProblox_UndoRedo_ActionHistory_h_Statics::ScriptStructInfo[] = {
		{ FTask::StaticStruct, Z_Construct_UScriptStruct_FTask_Statics::NewStructOps, TEXT("Task"), &Z_Registration_Info_UScriptStruct_Task, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTask), 2175692533U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_projProblox_Source_projProblox_UndoRedo_ActionHistory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UActionHistory, UActionHistory::StaticClass, TEXT("UActionHistory"), &Z_Registration_Info_UClass_UActionHistory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UActionHistory), 3409631882U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_projProblox_Source_projProblox_UndoRedo_ActionHistory_h_902906544(TEXT("/Script/projProblox"),
		Z_CompiledInDeferFile_FID_projProblox_Source_projProblox_UndoRedo_ActionHistory_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_projProblox_Source_projProblox_UndoRedo_ActionHistory_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_projProblox_Source_projProblox_UndoRedo_ActionHistory_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_projProblox_Source_projProblox_UndoRedo_ActionHistory_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_projProblox_Source_projProblox_UndoRedo_ActionHistory_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_projProblox_Source_projProblox_UndoRedo_ActionHistory_h_Statics::EnumInfo));
