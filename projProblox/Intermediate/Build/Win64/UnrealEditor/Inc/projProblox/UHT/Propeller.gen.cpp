...
#include "projProblox/Pickups/Propeller.h"
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APropeller_Statics::Class_MetaDataParams[] = {
		...
		{ "Comment", "/**\n * \n */" },
#endif
		{ "IncludePath", "Pickups/Propeller.h" },
		{ "ModuleRelativePath", "Pickups/Propeller.h" },
	};
#endif
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_APropeller_Statics::NewProp_propelForce = { "propelForce", nullptr, (EPropertyFlags)0x0020080000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(APropeller, propelForce), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_APropeller_Statics::NewProp_propelForce_MetaData), Z_Construct_UClass_APropeller_Statics::NewProp_propelForce_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_APropeller_Statics::NewProp_pushForce = { "pushForce", nullptr, (EPropertyFlags)0x0020080000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(APropeller, pushForce), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_APropeller_Statics::NewProp_pushForce_MetaData), Z_Construct_UClass_APropeller_Statics::NewProp_pushForce_MetaData) };
	...
	struct Z_CompiledInDeferFile_FID_Users_Deany_Documents_GitHub_problox_projProblox_Source_projProblox_Pickups_Propeller_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Deany_Documents_GitHub_problox_projProblox_Source_projProblox_Pickups_Propeller_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_APropeller, APropeller::StaticClass, TEXT("APropeller"), &Z_Registration_Info_UClass_APropeller, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APropeller), 2033396696U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Deany_Documents_GitHub_problox_projProblox_Source_projProblox_Pickups_Propeller_h_2421618744(TEXT("/Script/projProblox"),
		Z_CompiledInDeferFile_FID_Users_Deany_Documents_GitHub_problox_projProblox_Source_projProblox_Pickups_Propeller_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Deany_Documents_GitHub_problox_projProblox_Source_projProblox_Pickups_Propeller_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
