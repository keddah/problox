...
void EmptyLinkFunctionForGeneratedCodeprojProblox_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_projProblox()
	{
		if (!Z_Registration_Info_UPackage__Script_projProblox.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_projProblox_OnBadCamera__DelegateSignature,
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_projProblox_OnDeselected__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_projProblox_OnFirstLoad__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_projProblox(Z_Construct_UPackage__Script_projProblox, TEXT("/Script/projProblox"), Z_Registration_Info_UPackage__Script_projProblox, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0xD971470E, 0x0833AD89));
