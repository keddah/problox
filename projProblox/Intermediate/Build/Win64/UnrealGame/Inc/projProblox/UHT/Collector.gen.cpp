...
// End Cross Module References
	...
	DEFINE_FUNCTION(ACollector::execResetCells)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->ResetCells();
	...
	void ACollector::StaticRegisterNativesACollector()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "ResetCells", &ACollector::execResetCells },
		};
	...
	struct Z_Construct_UFunction_ACollector_ResetCells_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ACollector_ResetCells_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Collector.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ACollector_ResetCells_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ACollector, nullptr, "ResetCells", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04080401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ACollector_ResetCells_Statics::Function_MetaDataParams), Z_Construct_UFunction_ACollector_ResetCells_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_ACollector_ResetCells()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ACollector_ResetCells_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ACollector_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ACollector_ResetCells, "ResetCells" }, // 375431095
	};
	...
	struct Z_CompiledInDeferFile_FID_GitHub_FMP_problox_projProblox_Source_projProblox_Collector_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GitHub_FMP_problox_projProblox_Source_projProblox_Collector_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACollector, ACollector::StaticClass, TEXT("ACollector"), &Z_Registration_Info_UClass_ACollector, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACollector), 2894292026U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GitHub_FMP_problox_projProblox_Source_projProblox_Collector_h_3814446191(TEXT("/Script/projProblox"),
		Z_CompiledInDeferFile_FID_GitHub_FMP_problox_projProblox_Source_projProblox_Collector_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_GitHub_FMP_problox_projProblox_Source_projProblox_Collector_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
