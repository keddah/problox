...
/////////////// STICKY ///////////////
void AStickyThing::Tick(float DeltaSeconds)
{
	Super::Tick(DeltaSeconds);
	Unstick(DeltaSeconds);
}

void AStickyThing::Unstick(const float deltaTime) const
{
	if(!stuck) return;
...
void AStickyThing::NotifyHit(UPrimitiveComponent* MyComp, AActor* Other, UPrimitiveComponent* OtherComp,
